...
/**
 * @author power
 * @date 2/26/21 2:52 PM
 * @project ElephantOil
 * @description:
 */
public class LifeDiscountAdapter extends BaseQuickAdapter<OilDiscountEntity, BaseViewHolder> {

    public LifeDiscountAdapter(int layoutResId, @Nullable List<OilDiscountEntity> data) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, OilDiscountEntity item) {
        ...
        switch (helper.getAdapterPosition()) {
            ...
            case 1://平台优惠券
                ...
                } else if (item.getPlatformDesc().equals("请输入消费金额")) {
                    helper.setText(R.id.item_discount_tv, item.getPlatformDesc())
                            .setTextColor(R.id.item_discount_tv, mContext.getResources().getColor(R.color.color_B1));
                } else {
                    helper.setText(R.id.item_discount_tv, item.getPlatformDesc())
            ...
            case 2://商家优惠券
                ...
                if (item.getBusinessDesc().equals("请选择优惠券")) {
                    ...
                    helper.setText(R.id.item_discount_tv, item.getBusinessDesc())
                            .setTextColor(R.id.item_discount_tv, mContext.getResources().getColor(R.color.color_B1));
                } else if (item.getBusinessDesc().equals("请输入消费金额")) {
                    helper.setText(R.id.item_discount_tv, item.getBusinessDesc())
                            .setTextColor(R.id.item_discount_tv, mContext.getResources().getColor(R.color.color_B1));
                } else {
                    helper.setText(R.id.item_discount_tv, item.getBusinessDesc())
