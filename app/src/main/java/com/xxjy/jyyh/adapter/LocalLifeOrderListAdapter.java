...
public class LocalLifeOrderListAdapter extends BaseQuickAdapter<RefuelOrderBean, BaseViewHolder> {

    public LocalLifeOrderListAdapter(int layoutResId, @Nullable List<RefuelOrderBean> data) {
