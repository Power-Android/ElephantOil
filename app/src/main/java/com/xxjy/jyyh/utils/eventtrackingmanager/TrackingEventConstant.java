 ...
 * @author jiangm
 * @version 1.0
 * 包名： com.xxjy.jyyh.utils.eventtrackingmanager
 * 类说明：
 */
public class TrackingEventConstant {

    //车服事件统计
    //特惠洗车_首页_区域筛选
    public static final String CF_EVENT_HOME_DISTRICT_CHOOSE = "event_id=cfwash_home_districtchoose";
    //特惠洗车_首页_服务筛选_XXXX（xxx记录筛选项名称)
...
//    public static final String EVENT__HOME_GAS_BOX_ONE= "event_id=Home_GasBoxOne";
    ...
    //加油事件统计
    //油站卡片-一键加油
    public static final String EVENT_HOME_GASBOXONE = "event_id=Home_GasBoxOne";
    //我的按钮
    public static final String EVENT_HOME_MINE = "event_id=Home_mine";
    //小象会员banner
    public static final String EVENT_HOME_MAIN_VIPCARD_BANNER = "event_id=Home_main_VIPcard banner";
    //小象会员卡
